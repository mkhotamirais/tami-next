...
export default function RecentNews() {
  return (
    <section className="min-h-[40vh] lg:min-h-[70vh] px-3 sm:px-12 lg:px-24 py-12 bg-gray-50">
      <div className="flex items-center justify-between my-4">
        <h2 className="font-merriweather text-2xl font-semibold">Recent News</h2>
        <Link href="/web-design/school/school-1/news-and-events" className="text-blue-500">
          See all
          <FaArrowRight />
        </Link>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full h-full">
        {menu.map((item, index) => (
          <div key={index} className="shadow bg-white rounded-lg overflow-hidden flex flex-col">
            <Image
              src={item.image}
              width={300}
              height={300}
            ...
            />
            <div className="p-4 flex flex-col border flex-grow">
